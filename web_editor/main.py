...
def create_sample_files():
    """Создаём образцы файлов для демонстрации"""
    uploads_dir = Path('uploads')
    uploads_dir.mkdir(exist_ok=True)
    
    welcome_file = uploads_dir / 'добро_пожаловать.md'
    if not welcome_file.exists():
        content = """# Добро пожаловать в веб-редактор Markdown! 🚀

Это красочный и удобный редактор для работы с Markdown документами.

## Основные возможности

- **Живой предварительный просмотр** - видите результат в реальном времени
- **Подсветка синтаксиса** - удобное редактирование кода
- **Автоматическое оглавление** - навигация по заголовкам
- **Автосохранение** - ваши файлы всегда в безопасности
